...
class Fcn_resnet101(nn.Module):
    def __init__(self, model=torchvision.models.segmentation.fcn_resnet101, num_classes=21, aux_loss=True):
...
if __name__ == "__main__":                #to run it
    ...
    # model = Fcn_resnet101(model=torchvision.models.segmentation.fcn_resnet101, num_classes=14, ch=1)
    model = Fcn_resnet101(model=torchvision.models.segmentation.fcn_resnet101, num_classes=3, aux_loss=True)
    model.train()
    out = model(image)
    print(model(image))
