...
class QuickNat(nn.Module):
    ...
    def forward(self, input):
        ...
        d4 = self.decode4.forward(bn, out4, ind4)       ##starting from here raises the got 3 arg expected 2 when using anything other than se_block = "None" #Valid options : NONE, CSE, SSE, CSSE      
...
if __name__ == '__main__':
    ...
    image = torch.rand(10, 1, 240, 240)    #specify your image: batch size, Channel, height, width
    quicknat_model = QuickNat(net_params)
    quicknat_model.eval()
    out = quicknat_model(image)
    print(quicknat_model(image))
